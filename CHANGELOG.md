...
* Add ProtonDB search in [#12](https://github.com/elecordapp/elecord-extension/pull/12)
* Update readme with protondb search
* add protondb context menu search
* Fix Steam key details box in [#11](https://github.com/elecordapp/elecord-extension/pull/11)
* fix steam review score element selection
* update readme with extension stores
* fix highlighting hidden steam links
* create regression tests doc
* update copyright notice
* create privacy policy
* fix github action package version
* add chrome package to github action
* refactor github action
* create firefox package github action

**Full Changelog**: https://github.com/elecordapp/elecord-extension/compare/v2.0.1...v2.1.0
...
## New Contributors
* @hazzuk made their first contribution
